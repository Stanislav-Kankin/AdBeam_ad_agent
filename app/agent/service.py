...
class AgentService:
    ...
    async def explain_reports(self, reports, deterministic_text, chat_id, user_id=None):
        ...
        system = (
            ...
            "факты. Подготовь управленческий ответ не длиннее 2200 знаков. Сохрани структуру: "
            "главный вывод; до пяти ключевых показателей; подтверждённые изменения; до трёх "
            "действий; одна короткая строка о полноте данных. Не перечисляй все доступные "
